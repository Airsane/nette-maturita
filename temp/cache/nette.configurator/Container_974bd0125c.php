<?php
// source: E:\wamp64\www\nette-maturita\app/config/common.neon
// source: E:\wamp64\www\nette-maturita\app/config/local.neon
// source: array
...
class Container_974bd0125c extends Nette\DI\Container
{
    protected $tags = [
        'nette.inject' => [
            'application.1' => true,
    ...
    protected $wiring = [
        ...
        'App\Model\MyAuthenticator' => [['01']],
        'App\Model\UserManager' => [['02']],
        'App\Model\HouseManager' => [['03']],
        ...
        'App\AdminModule\Presenters\DashboardPresenter' => [2 => ['application.1']],
        'App\AdminModule\Presenters\HousePresenter' => [2 => ['application.2']],
        'App\AdminModule\Presenters\UserPresenter' => [2 => ['application.3']],
        'App\Presenters\Error4xxPresenter' => [2 => ['application.4']],
        'App\Presenters\ErrorPresenter' => [2 => ['application.5']],
        'App\Presenters\BasePresenter' => [2 => ['application.6', 'application.7', 'application.8', 'application.9']],
        'App\Presenters\HomepagePresenter' => [2 => ['application.6']],
        'App\Presenters\HousePresenter' => [2 => ['application.7']],
        'App\Presenters\ReservationPresenter' => [2 => ['application.8']],
    ...
    public function __construct(array $params = [])
    {
        ...
        $this->parameters += [
            'appDir' => 'E:\wamp64\www\nette-maturita\app',
            'wwwDir' => 'E:\wamp64\www\nette-maturita\www',
            'vendorDir' => 'E:\wamp64\www\nette-maturita\vendor',
            'debugMode' => true,
            'productionMode' => false,
            'consoleMode' => false,
            'tempDir' => 'E:\wamp64\www\nette-maturita\app/../temp',
        ];
    }


    public function createService01(): App\Model\MyAuthenticator
    {
        return new App\Model\MyAuthenticator($this->getService('database.default.context'));
    }


    public function createService02(): App\Model\UserManager
    {
        return new App\Model\UserManager($this->getService('database.default.context'));
    }


    public function createService03(): App\Model\HouseManager
    {
        return new App\Model\HouseManager($this->getService('database.default.context'));
    }


    public function createServiceApplication__1(): App\AdminModule\Presenters\DashboardPresenter
    {
    ...
    public function createServiceApplication__2(): App\AdminModule\Presenters\HousePresenter
    {
        $service = new App\AdminModule\Presenters\HousePresenter($this->getService('database.default.context'));
        $service->injectPrimary(
            $this,
            $this->getService('application.presenterFactory'),
            $this->getService('routing.router'),
    ...
    public function createServiceApplication__3(): App\AdminModule\Presenters\UserPresenter
    {
        $service = new App\AdminModule\Presenters\UserPresenter($this->getService('database.default.context'));
        $service->injectPrimary(
            $this,
            $this->getService('application.presenterFactory'),
            $this->getService('routing.router'),
    ...
    public function createServiceApplication__7(): App\Presenters\HousePresenter
    {
        $service = new App\Presenters\HousePresenter($this->getService('database.default.context'));
        $service->injectPrimary(
            $this,
            $this->getService('application.presenterFactory'),
            $this->getService('routing.router'),
    ...
    public function createServiceApplication__8(): App\Presenters\ReservationPresenter
    {
        $service = new App\Presenters\ReservationPresenter($this->getService('database.default.context'));
        $service->injectPrimary(
            $this,
            $this->getService('application.presenterFactory'),
            $this->getService('routing.router'),
    ...
    {
        $service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\wamp64\www\nette-maturita\app/../temp/cache/nette.application/touch'));
    ...
    {
        return new Nette\Caching\Storages\SQLiteJournal('E:\wamp64\www\nette-maturita\app/../temp/cache/journal.s3db');
    }


    public function createServiceCache__storage(): Nette\Caching\IStorage
    {
        return new Nette\Caching\Storages\FileStorage('E:\wamp64\www\nette-maturita\app/../temp/cache', $this->getService('cache.journal'));
    }


    public function createServiceContainer(): Container_974bd0125c
    {
        return $this;
    }
    ...
    {
        $service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=kratos', 'root', null, []);
    ...
    public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
    {
        return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
            ...
            public function __construct(Container_974bd0125c $container)
            {
            ...
            public function create(): Latte\Engine
            {
                ...
                $service->setTempDirectory('E:\wamp64\www\nette-maturita\app/../temp/cache/latte');
